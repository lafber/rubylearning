...
# course participants attempt
quiz = [0,0,0,1,0,0,1,1,0,1]


puts "The number of participants who did not attempt Quiz 1 is #{quiz.select{ |attempt| attempt == 0 }.size} out of #{quiz.size} total participants."
